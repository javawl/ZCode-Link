...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like LinkAgent to show its work?",
  ...
  "occupationOnboarding.memoryDescription":
    "Let LinkAgent remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting LinkAgent",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen LinkAgent.",
  ...
  "startup.global.starting_services": "Starting LinkAgent",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "LinkAgent will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another LinkAgent or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen LinkAgent. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen LinkAgent to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen LinkAgent.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a LinkAgent restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into LinkAgent",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to LinkAgent and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to LinkAgent",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.backToWorkspace": "Back to workspace",
  "login.title": "Welcome to LinkAgent",
  "login.description": "Connect your account to start using LinkAgent",
  ...
  "logout.confirm.title": "Disconnect and restart LinkAgent?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only LinkAgent Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About LinkAgent",
  ...
  "forceUpdate.title": "Update LinkAgent to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart LinkAgent to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the LinkAgent CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "LinkAgent checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the LinkAgent terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While LinkAgent is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the LinkAgent installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching LinkAgent task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by LinkAgent",
  ...
  "resourceManager.storage.diskUsage": "LinkAgent uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the LinkAgent desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "LinkAgent could not verify its Windows secure import component. Reinstall or update LinkAgent before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, LinkAgent will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by LinkAgent Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "LinkAgent provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This LinkAgent Agent cannot refresh OAuth status. Upgrade or restart LinkAgent, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to LinkAgent to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into LinkAgent",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to LinkAgent 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by LinkAgent automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in LinkAgent.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. LinkAgent uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.modelProvider.defaultModel.badge": "Default",
  "settings.modelProvider.defaultModel.current": "Current default model",
  "settings.modelProvider.defaultModel.set": "Set as default model",
  "settings.modelProvider.defaultModel.failed": "Could not save the default model: {reason}",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in LinkAgent after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "LinkAgent MCP",
  ...
  "sidebar.usage.plan.mcp": "LinkAgent MCP",
  "sidebar.usage.plan.zcodeMcp": "LinkAgent MCP",
  "sidebar.usage.plan.zcodeMcpDescription":
    "Daily aggregate quota for LinkAgent built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into LinkAgent. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. LinkAgent follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into LinkAgent",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by LinkAgent Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend LinkAgent with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into LinkAgent and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. LinkAgent follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into LinkAgent",
  ...
  "settings.commands.description":
    "Manage LinkAgent Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "LinkAgent Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into LinkAgent. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. LinkAgent follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into LinkAgent",
  ...
  "settingsSync.action.finish": "Start using LinkAgent",
  "settingsSync.agent.zcode": "LinkAgent Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current LinkAgent settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to LinkAgent",
  ...
  "onboarding.welcome.title": "Welcome to LinkAgent",
  "onboarding.welcome.start": "Start LinkAgent",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while LinkAgent imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "LinkAgent will copy {source} to {target}.\nIf the target file already exists, the LinkAgent default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask LinkAgent anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask LinkAgent anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, LinkAgent will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want LinkAgent to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart LinkAgent app and retry, or ask LinkAgent to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with LinkAgent in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for LinkAgent: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with LinkAgent in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current LinkAgent Agent session",
  ...
  "chat.error.noAvailableModel": "No model is available. Add a custom model in Settings.",
  ...
  "chat.quota.startPlan.modelExhausted":
    "{model} has reached its usage limit. Choose another model in Settings.",
  "chat.quota.startPlan.dailyExhausted":
    "The current model has reached its usage limit. Switch models or try again later.",
  ...
  "chat.quota.startPlan.concurrentLimit.retryExhausted":
    "The model service is busy and automatic retries are exhausted. Try again later.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'LinkAgent MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No LinkAgent MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  "chat.quota.providerLimited":
    "The model service has reached a limit. Check its configuration or choose another model in Settings.",
  ...
  "resourceManager.appUsage": "LinkAgent",
  ...
  "feedback.submit.template.section.copyErrorHeading": "LinkAgent Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while LinkAgent is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task LinkAgent can work on in the background, including the expected result and any constraints…",
  ...
  "offPeak.create.codingPlanToast":
    "This model does not support idle-time tasks. Check model settings or use a regular scheduled task.",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "LinkAgent Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "LinkAgent Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart LinkAgent",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart LinkAgent to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified LinkAgent plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "LinkAgent will verify the Computer Use tools against the exact session when your first session starts.",
